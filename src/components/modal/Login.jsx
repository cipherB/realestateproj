      ...
      <div className='p-7' >
        ...
        <div>
          <input 
            ...
            id='email'
            name='email'
            className='p-[10px] w-full text-lg mb-4'
            value={email}
          ...
          <input 
            ...
            name='password' 
            id='password'
            className='p-[10px] w-full text-lg mb-8'
            value={password}
          ...
          <button
            className='w-full py-2.5 rounded-sm bg-white flex justify-center items-center border-none text-lg mb-3 gap-x-4'
