  ...
  return (
    <div className='mx-20 w-full' >
      <nav className='border-y border-[#d8d8d8] py-6' >
        <ul className='flex justify-center gap-x-5 items-center list-none' >
          <li><a href="/" className='text-sm' >About</a></li>
          <li><a href="/" className='text-sm' >Zestmates</a></li>
          <li><a href="/" className='text-sm' >Research</a></li>
          <li><a href="/" className='text-sm' >Careers</a></li>
          <li><a href="/" className='text-sm' >Help</a></li>
          <li><a href="/" className='text-sm' >Advertise</a></li>
          <li><a href="/" className='text-sm' >Fair Housing Guide</a></li>
          <li><a href="/" className='text-sm' >Terms of Use</a></li>
          <li><a href="/" className='text-sm' >Privacy Portal</a></li>
          <li><a href="/" className='text-sm' >Cookie Preference</a></li>
          <li><a href="/" className='text-sm' >Blog</a></li>
          <li><a href="/" className='text-sm' >AI</a></li>
          <li><a href="/" className='text-sm' >Mobile Apps</a></li>
        </ul>
        <ul className='flex justify-center gap-x-5 items-center list-none' >
          <li><a href="/" className='text-sm' >Trulia</a></li>
          <li><a href="/" className='text-sm' >StreetEasy</a></li>
          <li><a href="/" className='text-sm' >HotPads</a></li>
          <li><a href="/" className='text-sm' >Out East</a></li>
          <li><a href="/" className='text-sm' >ShowingTime+</a></li>
        </ul>
      ...
      <div className='py-6' >
        <div className='mx-[280px] mb-6' >
          <p className='text-center text-[10px] text-[#54545A] leading-4' >
            ...
            accessibility of our<br/> web experience for everyone, and we welcome feedback and 
            accommodation requests. If you wish to report an issue or seek an accommodation, please
            <br/><a className='underline text-link' href='/' >let us know</a> 
          </p>
        </div>
        <div className='mx-[280px] mb-6 text-[10px]' >
        ...
        <div className='flex justify-center mb-6 items-center' >
          <a href="/" ><img src={Logo} alt="logo" className='cursor-pointer w-[152px] h-8 pl-2' />
          </a>
      ...
      <div className='w-full' >
        <img src={FooterArt} alt="footer" className='w-full h-[160px] mb-2' />
      </div>
    </div>
  )
}
